...
(function() {
  ...
  module.controller('GfImportOwsItemDirectiveController', function($scope,
  ...
  module.directive('gf3ImportOwsItem', function($compile, gaMapUtils) {
    ...
    return {
      ...
      controller: 'GfImportOwsItemDirectiveController',
