describe('gf3_print_service', function() {

  describe('gf3PrintService', function() {
    var gf3PrintService, $window, mockDoc, mockWinPrint;
    var winPrint = {
      print: function() {},
      close: function() {},
      document: {
    ...
    beforeEach(function() {
      ...
      inject(function($injector) {
        ...
        gf3PrintService = $injector.get('gf3PrintService');
      });
    ...
    describe('#htmlPrintout()', function() {
      ...
      it('prints a complete html page', function() {
        ...
        gf3PrintService.htmlPrintout('<div>my body</div>', '<meta></met<><script src="print.js"></script><link href="print.css">', function() {$window.isOnPrintLoad = true});
